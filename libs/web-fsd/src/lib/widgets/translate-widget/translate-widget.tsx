...
<div className=" h-1/3 flex items-end" >
  <TranslateForm  setResult={setResult} onTranslated={onTranslated} disabled={isLoad} isError={isErr} onLoad={onLoad} value={source} />
</div>
{isError && "Error"}


  {IsTranslatedVisible && (  <div className="flex justify-between mt-2 pl-1">
    {isLoad && <SkeletonUi />}

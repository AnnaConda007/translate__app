...
export const InputUi= ({ value,isTransparent, onChange, onClick,status=InputStatus.None,textInfo, isReadOnly=false , placeholder}:InputUiProps) => {
...
const cursor = isReadOnly ? "cursor-pointer" :"cursor-text"
    ...
    className={`w-full ${bgColor} outline-none rounded-md  ${cursor}`} value={value} type="text" onChange={onChange} onClick={onClick} />
<div>

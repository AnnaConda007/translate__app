...
export const InputUi= ({ value,isTransparent, onChange, onEnterHandle,onClick,status=InputStatus.None,textInfo, isReadOnly=false , placeholder}:InputUiProps) => {
...
onEnterHandle()  }
    ...
    className={`w-full ${bgColor} outline-none rounded-md  ${cursor}`} value={value} type="text" onChange={onChange} onClick={onClick} onKeyDown={onEnter} />
<div>

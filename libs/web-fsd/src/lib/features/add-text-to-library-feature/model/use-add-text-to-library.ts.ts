...
const [isAlreadyExistText, setIsAlreadyExist] =useState<string | null>(null)
 ...
 const handleSendText =   async ({title,content} :{title:string,content:string})=>{
 ...
 return {
    title,setTextTitle, content, handleFileUpload, handleSendText,fileAdded,isAlreadyExistText, setFileAdded, setIsAlreadyExist
 }
}